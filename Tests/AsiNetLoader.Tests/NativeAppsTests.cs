...
public class NativeAppsTests
{
    ...
    {
        { "x64", "TestNativeAppX64.exe" },
        { "x86", "TestNativeAppX86.exe" },
        { "x64", "TestNetFrameworkAppX64.exe" },
        { "x86", "TestNetFrameworkAppX86.exe" },
        { "x64", "TestNet8AppX64.exe" },
        { "x86", "TestNet8AppX86.exe" },
        { "x64", "TestNet10AppX64.exe" },
        { "x86", "TestNet10AppX86.exe" },
    };
