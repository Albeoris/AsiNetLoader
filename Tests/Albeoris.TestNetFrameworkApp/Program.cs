...
namespace Albeoris.TestNetFrameworkApp
{
    internal class Program
    {
        public static void Main(String[] args)
        {
            ...
            Console.WriteLine($"[{timestamp}] Starting .NET Framework test app...");
            ...
            Console.WriteLine($"[{timestamp}] .NET Framework app finished.");
        }
